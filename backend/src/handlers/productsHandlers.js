...
const createProductsHandler = async(req, res) => {
    ...
    const {name, price, category, description, stock, image, origin} = req.body;

    try{

        const newProduct = await createProduct(name, price, category, description, stock, image, origin)
