...
import { getAllProducts, filterByCategory,filterByOrigin} from "../../features/productsSlice";
  ...
  return (
    ...
    <div className=" grid grid-cols-3 gap-1 mt-5 mx-2 grid-rows-3">
      <select onChange={handlerFilterByCategory}>
        <option disabled selected defaultValue>Categories</option>
      ...
      <select onChange={handlerFilterByOrigin}>
                <option disabled selected defaultValue>Origin</option>
                <option value="All">All</option>
